...
export const R16 = [
 ...
 {d:"Sat Jul 4",ds:"Saturday, July 4",t:"5:00",z:"PM ET",round:"R16",h:"PAR",a:"FRA",v:"MetLife Stadium",c:"East Rutherford, NJ",fav:"a",conf:"lean",
 ...
 // ── Sunday, July 5 ───────────────────────────────────────────────────────────
 {d:"Sun Jul 5",ds:"Sunday, July 5",t:"4:00",z:"PM ET",round:"R16",h:"BRA",a:"NOR",v:"Lincoln Financial Field",c:"Philadelphia, PA",fav:"h",conf:"high",
  why:"Brazil swept through the group stage and dismantled Japan 2-1 in the Round of 32. Norway ride Haaland's momentum after beating Ivory Coast, but the quality gap is significant. Vinícius and Raphinha should have too much for Norway's compact shape."},
...
// Results in. The last four standing: France, Spain, England, Argentina.
export const QF = [
 {d:"Thu Jul 9",ds:"Thursday, July 9",t:"4:00",z:"PM ET",round:"QF",h:"FRA",a:"MAR",v:"Gillette Stadium",c:"Foxborough, MA",fav:"h",conf:"lean",
  why:"Morocco's fairytale ran into France's ceiling. The Atlas Lions defended for their lives but Mbappé's movement and France's midfield control were too much. France into the semi-finals with a clinical 2-0."},
 {d:"Fri Jul 10",ds:"Friday, July 10",t:"3:00",z:"PM ET",round:"QF",h:"ESP",a:"BEL",v:"SoFi Stadium",c:"Inglewood, CA",fav:"h",conf:"lean",
  why:"Belgium's golden generation pushed Spain hard, but the tiki-taka machine found a way. Pedri ran the game and Spain edged a tense 2-1 to reach the last four."},
 {d:"Sat Jul 11",ds:"Saturday, July 11",t:"5:00",z:"PM ET",round:"QF",h:"NOR",a:"ENG",v:"Hard Rock Stadium",c:"Miami Gardens, FL",fav:"a",conf:"lean",
  why:"Haaland's Norway had ridden a wave of momentum, but England's depth and set-piece quality told. Bellingham and Kane combined to see off the Norwegians 2-1 and book a semi-final."},
 {d:"Sat Jul 11",ds:"Saturday, July 11",t:"9:00",z:"PM ET",round:"QF",h:"ARG",a:"SUI",v:"Arrowhead Stadium",c:"Kansas City, MO",fav:"h",conf:"high",
  why:"Switzerland's stubborn block held for an hour before Messi unlocked it. The champions pulled away late for a 3-1 win, and Argentina march on toward a title defence."},
];

// ─── SEMI-FINALS — July 14–15 ─────────────────────────────────────────────────
// Results in. Spain and Argentina go through to the Final.
export const SF = [
 {d:"Tue Jul 14",ds:"Tuesday, July 14",t:"3:00",z:"PM ET",round:"SF",h:"FRA",a:"ESP",v:"AT&T Stadium",c:"Arlington, TX",fav:"a",conf:"lean",
  why:"Spain were imperious. France's pace never got going against a Spanish side that controlled every phase, and two clinical goals settled it. Spain win 2-0 and reach a World Cup final without having trailed for a single minute all tournament."},
 {d:"Wed Jul 15",ds:"Wednesday, July 15",t:"3:00",z:"PM ET",round:"SF",h:"ENG",a:"ARG",v:"Mercedes-Benz Stadium",c:"Atlanta, GA",fav:"a",conf:"lean",
  why:"A World Cup classic renewed, and once again Argentina found a way. England pushed them all the way but Messi and the defending champions have a habit of winning the biggest games. Argentina edge it 2-1 and Messi is 90 minutes from back-to-back titles."},
];

// ─── FINAL — July 19 ──────────────────────────────────────────────────────────
// One match left. Spain vs Argentina at MetLife Stadium.
export const FINAL = [
 {d:"Sun Jul 19",ds:"Sunday, July 19",t:"3:00",z:"PM ET",round:"Final",h:"ESP",a:"ARG",v:"MetLife Stadium",c:"East Rutherford, NJ",fav:null,conf:"toss",
  why:"It comes down to this. Spain's suffocating possession and relentless press against Messi and the reigning champions Argentina. Spain have not trailed all tournament; Argentina have the tournament's most decisive player and the nerve of winners. A World Cup final worthy of the name — and it is a genuine coin-flip."},
];
